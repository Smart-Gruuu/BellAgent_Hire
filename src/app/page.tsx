...
export default function HomePage() {
  return (
    <main className="min-h-[80vh]">
      {/* Hero - exact Bellagent structure */}
      <div
        className="bg-cover bg-[bottom_center] bg-no-repeat bg-[#FAFAFA] min-h-[60vh]"
        style={{
          backgroundImage: "url('/data/home-bg.jpg')",
        }}
      >
        <div className="container flex flex-col items-center pt-10 md:pt-20 lg:pt-30 pb-15 relative z-10">
          <h2 className="text-center text-gray-900 text-[30px] sm:text-[42px] md:text-[60px] leading-[38px] sm:leading-[54px] md:leading-[72px] font-medium">
            Build the future of{' '}
            <span className="text-brand-gradient-600">AI-powered operations.</span>
          </h2>
          <span className="text-[14px] sm:text-[20px] text-center text-gray-600 mt-4 max-w-[768px] mx-auto">
          ...
          <p className="font-normal text-sm leading-5 text-[#535862] mt-10">
            Interested in learning more?{' '}
            <Link href="https://bellagent.ai/calendly" target="_blank" rel="noopener noreferrer" className="text-[var(--brand-600)] hover:underline font-semibold">
      ...
      {/* Trusted by - exact Bellagent structure */}
      <div className="py-[60px] md:py-[90px]">
        <div className="container">
          <h3 className="text-gray-600 text-[18px] leading-[24px] font-medium text-center">
          ...
          {/* Mobile: scrolling marquee with gradient fades */}
          <div className="relative flex md:hidden overflow-hidden mt-8">
            <div className="pointer-events-none absolute inset-y-0 left-0 w-8 sm:w-32 bg-gradient-to-r from-white to-transparent z-10" aria-hidden />
            <div className="pointer-events-none absolute inset-y-0 right-0 w-8 sm:w-32 bg-gradient-to-l from-white to-transparent z-10" aria-hidden />
            <div className="flex animate-loop whitespace-nowrap gap-x-5 sm:gap-7 flex-nowrap">
          ...
          {/* Desktop: static row */}
          <div className="company-logos !hidden md:!flex mt-8">
            <span className="company-logo-box">
              <Image src="/data/enova.svg" alt="Enova" width={133} height={40} className="h-10 w-auto block" />
            </span>
            <span className="company-logo-box">
      ...
      {/* Deploy instantly - three cards (Bellagent exact) */}
      <div className="bg-brand-25">
        <div className="container">
          <div className="w-full py-[60px] md:py-[90px]">
            <h2 className="text-center text-gray-900 text-[30px] sm:text-[32px] md:text-[36px] leading-[38px] sm:leading-[40px] md:leading-[44px] font-medium mb-6">
              Deploy instantly. <span className="text-brand-gradient-600">Save Money.</span> Secure Your Systems.
            </h2>
            <div className="flex flex-col md:flex-row items-center md:items-start flex-wrap -m-4 pt-7 text-gray-600 text-center">
              <div className="w-full md:w-1/3 p-4">
                ...
                <div className="mt-5">
                  ...
                  <p className="text-[16px] leading-[24px] mt-4">Launch faster with prebuilt frameworks designed around real industry workflows.</p>
                </div>
              </div>
              <div className="w-full md:w-1/3 p-4">
                <div className="bg-brand-50 rounded-[16px] overflow-hidden">
                ...
                <div className="mt-5">
                  ...
                  <p className="text-[16px] leading-[24px] mt-4">Connect instantly with thousands of apps, defaulting to your compliance on day one.</p>
                </div>
              </div>
              <div className="w-full md:w-1/3 p-4">
                <div className="bg-brand-50 rounded-[16px] overflow-hidden">
                ...
                <div className="mt-5">
                  ...
                  <p className="text-[16px] leading-[24px] mt-4">Your command center for system security, visibility, and control.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Purpose-Built / Why join - left-border cards */}
      <div className="py-[60px] md:py-[90px]">
        <div className="container">
          <div className="w-full max-w-[768px] mb-12">
            ...
            <h4 className="font-normal text-xl leading-[30px] text-gray-600 mt-4">
              We deliver ready-to-run AI Agents that automate the work your team depends on—so productivity never stalls and high-value work always moves forward.
            </h4>
          </div>
          <div className="flex flex-wrap -mx-3">
            <div className="flex flex-col p-3 w-full md:w-1/2 lg:w-1/3">
              <div className="flex flex-col p-3 pl-6 pr-0 border-l-[4px] border-l-gray-100">
                ...
                <p className="text-base leading-6 text-gray-600 font-normal mt-1.5">Bellagent delivers consistent, high-trust automation that scales with you. AI Agents stay online, accurate, and auditable across every workflow.</p>
              </div>
            </div>
            <div className="flex flex-col p-3 w-full md:w-1/2 lg:w-1/3">
              <div className="flex flex-col p-3 pl-6 pr-0 border-l-[4px] border-l-gray-100">
                <h3 className="text-lg font-semibold leading-7 text-gray-900">Maximize Productivity</h3>
                <p className="text-base leading-6 text-gray-600 font-normal mt-1.5">Turn simple and complex workflows into self-running systems. Bellagent handles everything from routine tasks to deep reasoning and decisions.</p>
              </div>
            </div>
            <div className="flex flex-col p-3 w-full md:w-1/2 lg:w-1/3">
              <div className="flex flex-col p-3 pl-6 pr-0 border-l-[4px] border-l-gray-100">
                <h3 className="text-lg font-semibold leading-7 text-gray-900">Remove Blockers</h3>
                <p className="text-base leading-6 text-gray-600 font-normal mt-1.5">From lead intake to support tickets, Bellagent connects your apps and automates handoffs in real time so progress flows and teams move faster.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container py-[50px]">
          <div className="flex flex-col items-center md:items-start w-full max-w-[728px] text-center md:text-left">
            ...
            <h4 className="font-normal text-xl leading-[30px] text-gray-600 mt-2">
              From research to real time lead conversion, Bellagent automates the busy work so you can focus on growing your business.
            </h4>
